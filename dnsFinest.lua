...
function Xerath:RCombo(enemy)
    ...
    local rstacks = 1
    if myHero:GetSpellData(_R).level == 1 then rstacks = 4 end
    if myHero:GetSpellData(_R).level == 2 then rstacks = 5 end
    if myHero:GetSpellData(_R).level == 3 then rstacks = 6 end
